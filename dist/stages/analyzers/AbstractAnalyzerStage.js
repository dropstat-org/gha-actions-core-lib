...
exports.AbstractAnalyzerStage = void 0;
const core = __importStar(require("@actions/core"));
const AbstractStage_1 = require("../base/AbstractStage");
class AbstractAnalyzerStage extends AbstractStage_1.AbstractStage {
    mapResult(exitCode) {
        const map = this.resultMap();
        return map[exitCode] ?? 'failure';
    }
    handleResult(result, stageName, softFail) {
        switch (result) {
            case 'success':
...
exports.AbstractAnalyzerStage = AbstractAnalyzerStage;
//# sourceMappingURL=AbstractAnalyzerStage.js.map